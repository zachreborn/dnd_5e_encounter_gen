...
cr_dict = {
    ...
    'Kobold': [195, '1/8', 25, 'Small', 'Humanoid', 'kobold'],
    'Manes': [60, '1/8', 25, 'Small', 'Fiend', 'demon'],
    'Mastiff': [332, '1/8', 25, 'Medium', 'Beast', ''],
    'Merfolk': [218, '1/8', 25, 'Medium', 'Humanoid', 'merfolk'],
    ...
    # CR 1/4 - 50XP
    'Aarakocra': [12, '1/4', 50, 'Medium', 'Humanoid', 'aarakocra'],
    ...
    'Bullywug': [35, '1/4', 50, 'Medium', 'Humanoid', 'bullywug'],
    'Constrictor snake': [320, '1/4', 50, 'Large', 'Beast', ''],
    'Draft horse': [321, '1/4', 50, 'Large', 'Beast', ''],
    'Dretch': [57, '1/4', 50, 'Small', 'Fiend', 'demon'],
    'Drow': [128, '1/4', 50, 'Medium', 'Humanoid', 'elf'],
    ...
    'Goblin': [166, '1/4', 50, 'Small', 'Humanoid', 'goblinoid'],
    'Grimlock': [175, '1/4', 50, 'Medium', 'Humanoid', 'grimlock'],
    'Kenku': [194, '1/4', 50, 'Medium', 'Humanoid', 'kenku'],
    'Kuo-toa': [199, '1/4', 50, 'Medium', 'Humanoid', 'kuo-toa'],
    ...
    'Troglodyte': [290, '1/4', 50, 'Medium', 'Humanoid', 'troglodyte'],
    'Violet fungus': [138, '1/4', 50, 'Medium', 'Plant', ''],
    'Winged kobold': [195, '1/4', 50, 'Small', 'Humanoid', 'kobold'],
    ...
    'Deep gnome': [164, '1/2', 100, 'Small', 'Humanoid', 'gnome'],
    ...
    'Gnoll': [163, '1/2', 100, 'Medium', 'Humanoid', 'gnoll'],
    'Gray ooze': [243, '1/2', 100, 'Medium', 'Ooze', ''],
    'Hobgoblin': [186, '1/2', 100, 'Medium', 'Humanoid', 'goblinoid'],
    'Ice mephit': [215, '1/2', 100, 'Small', 'Elemental', ''],
    'Jackalwere': [193, '1/2', 100, 'Medium', 'Humanoid', 'shapechanger'],
    'Lizardfolk': [204, '1/2', 100, 'Medium', 'Humanoid', 'lizardfolk'],
    ...
    'Sahuagin': [263, '1/2', 100, 'Medium', 'Humanoid', 'sahuagin'],
    ...
    'Bugbear': [33, '1', 200, 'Medium', 'Humanoid', 'goblinoid'],
    ...
    'Thri-kreen': [288, '1', 200, 'Medium', 'Humanoid', 'thri-kreen'],
    'Tiger': [339, '1', 200, 'Large', 'Beast', ''],
    'Young faerie dragon': [133, '1', 200, 'Tiny', 'Dragon', ''],
    'Yuan-ti pureblood': [310, '1', 200, 'Medium', 'Humanoid', 'yuan-ti'],
    # CR2 = 450XP
    ...
    'Githzerai monk': [161, '2', 450, 'Medium', 'Humanoid', 'gith'],
    'Gnoll pack lord': [163, '2', 450, 'Medium', 'Humanoid', 'gnoll'],
    ...
    'Lizardfolk shaman': [205, '2', 450, 'Medium', 'Humanoid', 'lizardfolk'],
    'Merrow': [219, '2', 450, 'Large', 'Monstrosity', ''],
    'Mimic': [220, '2', 450, 'Medium', 'Monstrosity', 'shapechanger'],
    ...
    'Orc eye of Gruumsh': [247, '2', 450, 'Medium', 'Humanoid', 'orc'],
    ...
    'Wererat': [209, '2', 450, 'Medium', 'Humanoid', 'human, shapechanger'],
    ...
    'Bearded devil': [70, '3', 700, 'Medium', 'Fiend', 'devil'],
    'Blue dragon wyrmling': [91, '3', 700, 'Medium', 'Dragon', ''],
    'Bugbear chief': [33, '3', 700, 'Medium', 'Humanoid', 'goblinoid'],
    'Displacer beast': [81, '3', 700, 'Large', 'Monstrosity', ''],
    'Doppelganger': [82, '3', 700, 'Medium', 'Monstrosity', 'shapechanger'],
    'Giant scorpion': [327, '3', 700, 'Large', 'Beast', ''],
    'Githyanki warrior': [160, '3', 700, 'Medium', 'Humanoid', 'gith'],
    ...
    'Gnoll fang of Yeenoghu': [163, '4', 1100, 'Medium', 'Fiend', 'gnoll'],
    'Helmed horror': [183, '4', 1100, 'Medium', 'Construct', ''],
    'Incubus': [284, '4', 1100, 'Medium', 'Fiend', 'shapechanger'],
    'Lamia': [201, '4', 1100, 'Large', 'Monstrosity', ''],
    'Lizard king/queen': [205, '4', 1100, 'Medium', 'Humanoid', 'lizardfolk'],
    'Orc war chief': [246, '4', 1100, 'Medium', 'Humanoid', 'orc'],
    'Red dragon wyrmling': [98, '4', 1100, 'Medium', 'Dragon', ''],
    'Sea hag (in coven)': [179, '4', 1100, 'Medium', 'Fey', ''],
    'Shadow demon': [64, '4', 1100, 'Medium', 'Fiend', 'demon'],
    'Succubus': [285, '4', 1100, 'Medium', 'Fiend', 'shapechanger'],
    'Wereboar': [209, '4', 1100, 'Medium', 'Humanoid', 'human, shapechanger'],
    'Weretiger': [210, '4', 1100, 'Medium', 'Humanoid', 'human, shapechanger'],
    # CR5 is 1800XP
    'Air elemental': [124, '5', 1800, 'Large', 'Elemental', ''],
    'Barbed devil': [70, '5', 1800, 'Medium', 'Fiend', 'devil'],
    ...
    'Drow elite warrior': [128, '5', 1800, 'Medium', 'Humanoid', 'elf'],
    ...
    'Half-red dragon veteran': [180, '5', 1800, 'Medium', 'Humanoid', 'human'],
    'Hill giant': [155, '5', 1800, 'Huge', 'Giant', ''],
    'Mezzoloth': [313, '5', 1800, 'Medium', 'Fiend', 'yugoloth'],
    ...
    'Sahuagin baron': [264, '5', 1800, 'Large', 'Humanoid', 'sahuagin'],
    ...
    'Githzerai zerth': [161, '6', 2300, 'Medium', 'Humanoid', 'gith'],
    'Hobgoblin warlord': [187, '6', 2300, 'Medium', 'Humanoid', 'goblinoid'],
    'Invisible stalker': [192, '6', 2300, 'Medium', 'Elemental', ''],
    'Kuo-toa archpriest': [200, '6', 2300, 'Medium', 'Humanoid', 'kuo-toa'],
    ...
    'Drow mage': [129, '7', 2900, 'Medium', 'Humanoid', 'elf'],
    ...
    'Yuan-ti abomination': [308, '7', 2900, 'Large', 'Monstrosity', 'shapechanger, yuan-ti'],
    # CR8 is 3900XP
    'Assassin': [343, '8', 3900, 'Medium', 'Humanoid', ''],
    'Chain devil': [72, '8', 3900, 'Medium', 'Fiend', 'devil'],
    'Cloaker': [41, '8', 3900, 'Large', 'Aberration', ''],
    'Drow priestess of Lolth': [129, '8', 3900, 'Medium', 'Humanoid', 'elf'],
    'Fomorian': [136, '8', 3900, 'Huge', 'Giant', ''],
    'Frost giant': [155, '8', 3900, 'Huge', 'Giant', ''],
    'Githyanki knight': [160, '8', 3900, 'Medium', 'Humanoid', 'gith'],
    'Green slaad': [277, '8', 3900, 'Large', 'Aberration', 'shapechanger'],
    ...
    'Glabrezu': [58, '9', 5000, 'Large', 'Fiend', 'demon'],
    'Gray slaad': [277, '9', 5000, 'Medium', 'Aberration', 'shapechanger'],
    'Nycaloth': [314, '9', 5000, 'Large', 'Fiend', 'yugoloth'],
    ...
    'Nalfeshnee': [62, '13', 10000, 'Large', 'Fiend', 'demon'],
    'Rakshasa': [257, '13', 10000, 'Medium', 'Fiend', ''],
    'Storm giant': [156, '13', 10000, 'Huge', 'Giant', ''],
    'Ultroloth': [314, '13', 10000, 'Medium', 'Fiend', 'yugoloth'],
    'Vampire': [297, '13', 10000, 'Medium', 'Undead', 'shapechanger'],
    ...
    'Ice devil': [75, '14', 11500, 'Large', 'Fiend', 'devil'],
    # CR15 is 13000XP
    ...
    'Vampire (spellcaster)': [297, '15', 13000, 'Medium', 'Undead', 'shapechanger'],
    'Vampire (warrior)': [297, '15', 13000, 'Medium', 'Undead', 'shapechanger'],
    # CR16 is 15000
    ...
    'Goristro': [59, '17', 18000, 'Huge', 'Fiend', 'demon'],
    # CR18 is 20000XP
    ...
    'Pit fiend': [77, '20', 25000, 'Large', 'Fiend', 'devil'],
    # CR21 is 33000XP
    ...
    'Empyrean': [130, '23', 50000, 'Huge', 'Celestial', 'titan'],
    'Kraken': [197, '23', 50000, 'Gargantuan', 'Monstrosity', 'titan'],
    # CR24 is 62000XP
    'Ancient gold dragon': [113, '24', 62000, 'Gargantuan', 'Dragon', ''],
    'Ancient red dragon': [97, '24', 62000, 'Gargantuan', 'Dragon', ''],
    # CR30 is 155000XP
    'Tarrasque': [286, '30', 155000, 'Gargantuan', 'Monstrosity', 'titan'],
    }